...
export const booksTableData = [
  {
    cover: avatar1,        // Book cover image
    title: "The Great Gatsby",
    author: "F. Scott Fitzgerald",
    genre: "Classic",
    publisher: "Charles Scribner's Sons",
    status: "Available",  // Availability status
    publicationDate: "10/04/1925",  // Date of publication
  },
  {
    cover: avatar2,
